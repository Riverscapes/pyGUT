...
#unitcats: what is the full list of attribute category possibible, if not specified will use list based on attribute (right now just coded for basic UnitForm and UnitShape)
...
#GUTrunpath="E:\\Box Sync\\ET_AL\\Projects\\USA\\CHaMP\\CHaMP_ResearchProjects\\GUT\\wrk_Data\\Lemhi\\CBW05583-028079\\VISIT_1029\\ModelRuns/Output/GUT_2.0/Run_B75P25CT"


makesiteGUTunitmetrics=function(GUTrunpath, layer="", attribute="", unitcats="None"){
  ...
  ################################
  print("Calculating Tier2 Metrics")
  #reads in Tier2
  if(file.exists(paste(GUTrunpath, layer, sep="\\"))){
    ...
    ##I can add more by unit metrics here--- for shape and etc.
  ...
  if(unitcats=="None"){ 
    ...
    if(attribute=="UnitShape"){
    unitcats=c("Concavity", "Convexity","Planar")
    }
